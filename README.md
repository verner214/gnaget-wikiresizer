...
* Projektet är oförändrat och fungerar som om jag hade använt orginallänken, ville bara ha kontroll över det. UPDATE! har rättat en bugg, division by zero.
* Har byggt mha vs2017 lokalt. Måste inte göras eftersom byggresultat inte checkas in (.gitconfig) och behöver såklart inte checkas in, azure bygger.
...
* OBS! när man checkar in ny kod behöver man gå in i azure och synca/restarta etc. så att nya koden används.
